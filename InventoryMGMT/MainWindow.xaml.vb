Class MainWindow 
    ...
    Private Sub add_bttn_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles add_bttn.Click
        ...
        Dim total_price_current As Double

        If (search_list(0)).stock > 0 Then
        ...
        For current_item_index = 0 To purchase_list.Count - 1
            If search_list(0).item_number = purchase_list(current_item_index).item_number Then
                If purchase_list(current_item_index).stock > 0 Then
    ...
    Private Sub cancel_bttn_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles cancel_bttn.Click
        'need to change stock back and clear all tran items
